    ...
    return (
        <div id="background">
            <div className="container mx-auto p-4 mt-16 md:mt-24">
                ...
                {pokemonData && (
                    <div className="mt-8 capitalize rounded-md md:flex justify-around bg-white/[.06] backdrop-blur">
                        <div>
                            <img className="circletet w-20" src={putih} alt="circle" />
                            <img
                                className="gbrPokee h-80 z-30"
                        ...
                        <div className="h-full flex my-auto">
                            <div className="card-inner p-4 md:p-0 h-full text-white">
                                <h2 className="text-2xl font-bold">{pokemonData.name} #00{pokemonData.id}</h2>  
                                <p>
